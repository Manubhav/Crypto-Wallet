...
//  CryptoWallet
//
//  Created by Manuela Penuela on 17/5/2024.
//
...
#Preview {
    ListItemView2(coin: CryptoCurrency(id: "bitcoin", symbol: "BTC", name: "Bitcoin", image: URL(string: "https://assets.coingecko.com/coins/images/1/large/bitcoin.png?1696501400")!, current_price: 17000.0, market_cap: 893.12, price_change_percentage_24h: 0.0))
}
